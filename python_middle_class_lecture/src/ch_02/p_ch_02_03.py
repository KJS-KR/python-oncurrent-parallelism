...
# 가격 정보(인상 전)
print("-------- Price Information (Before Prise Raises) --------")
...
# 가격 정보(인상 후)
print(
    "-------- Price Information (After Prise Raises : Not Used Class Method ) --------"
)
...
# 가격 정보(인상 후 : 클래스메소드)
print("-------- Price Information (After Prise Raises : Used Class Method ) --------")
print(car1.get_price_culc())
print(car2.get_price_culc())
print()
...
# 별도의 메소드 작성 후 호출
print("-------- Create and Call the Separate Method  --------")
print(is_bmw(car1))
print(is_bmw(car2))
print()
